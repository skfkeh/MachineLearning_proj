...
#         if predict_button_rf:
        ...
        st.subheader('모델 훈련이 잘 되었는지 시각화')
        r1_col, r2_col = st.columns(2)
        r1_col.image('https://github.com/skfkeh/MachineLearning/blob/main/img/initial_rf.png?raw=true',caption='초기 파라미터 값 그래프')
        r2_col.image('https://github.com/skfkeh/MachineLearning/blob/main/img/optim_rf.png?raw=true',caption='최적의 파라미터 적용 그래프')
...
#         st.plotly_chart(fig_xg, key = keys[2])
    ...
    rmse_dt = pd.DataFrame(
        [['DecisionTree', '2707.9318335945104', '2808.279093924912', 2808.279093924912 - 2707.9318335945104],
         ...
         ['XGBoost', '2218.3959333480802', '2530.3043605988805', 2530.3043605988805 - 2218.3959333480802]],
    ...
    st.success('RandomForest의 오차 간격이 가장 작으므로 가장 효율적이라고 할 수 있다.', icon="✅")
#     st.write('RandomForest의 오차 간격이 가장 작으므로 가장 효율적이라고 할 수 있다.')
